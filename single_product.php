          ...
          <div class="row">
            <div class="col-md-6">
              <div data-options="{&quot;animation&quot;: &quot;slide&quot;, &quot;controlNav&quot;: true}" class="flexslider nav-inside control-nav-dark">
                <ul class="slides">
                  <li>
                    <img src="images/products/<?php echo $product_data['image']; ?>" alt="">
                  </li>
                  <li>
                    <img src="images/products/<?php echo $product_data['image']; ?>" alt="">
                  </li>
            ...
            <div class="col-md-5 col-md-offset-1">
              <div class="title mt-0">
                <h2><?php echo $product_data['product_name']; ?><span class="red-dot"></span></h2>
                <p class="m-0">Free Shipping Worldwide</p>
              </div>
              <div class="single-product-price">
                <div class="row">
                  <div class="col-xs-6">
                    <h3><del><?php echo "Tk"; echo $product_data['regular_price']; ?></del><span><?php echo "Tk"; echo $product_data['sale_price']; ?></span></h3>
                  </div>
              ...
              <div class="single-product-desc">
                ...
                <span><?php echo $product_data['category']; ?></span>
                <label style="padding-left: 15px;">Tag :</label>
                <span><?php echo $product_data['tag']; ?></span>
                <label style="padding-left: 15px;">Brand :</label>
                <span><?php echo $product_data['brand']; ?></span>
              </div>
<!-- 
