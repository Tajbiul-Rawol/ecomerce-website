              ...
              <div class="search-form">
                <form action="<?php echo $_SERVER['PHP_SELF'];?>" method= "POST">
                  <div class="input-group">
                    ...
                    <input type="text" placeholder="Search" name="search" class="form-control"><span class="input-group-btn"><input type="submit" name="search-btn" class="btn btn-color"><span><i class="ti-search"></i></span>
                    </span>
            ...
            <div class="container-fluid">
              <div class="row">
                <?php 
                                ...
                                $sql = "SELECT * FROM products WHERE category='$search' OR brand='$search' OR product_name LIKE '%$search%' OR tag LIKE '%$search%' ";
                ...
                <div class="col-md-4 col-sm-6">
                  <div class="shop-product">
                    <div class="product-thumb">
                      <a href="#">
                        <img src="images/products/<?php echo $single_data['image'] ?>" alt="">
                      </a>
                      <div class="product-overlay">
                        <a href="single_product.php?id=<?php echo $single_data['id'] ?>" class="btn btn-color-out btn-sm">View Data<i class="ti-bag"></i></a>
                        
                        <a  href="edit_product.php?id=<?php echo $single_data['id'] ?>" class="btn btn-color-out btn-sm">Edit Data<i class="ti-bag"></i></a>
                        
                        <a id="delete" href="delete_product.php?id=<?php echo $single_data['id'] ?>" class="btn btn-color-out btn-sm">Delete Data<i class="ti-bag"></i></a>
                      </div>
                    </div>
                    <div class="product-info">
                      <h4 class="upper"><a href="#"><?php echo $single_data['product_name']; ?></a></h4><span><?php echo"<del>"; echo $single_data['regular_price']; echo"</del>"; echo $single_data['sale_price'];?></span>
